...
export PORT=8098
export PUBLIC_DIR=/opt/einsatzkleidung/public
# /data ist das persistente Volume des Add-ons – überlebt Update & Neustart.
export DATA_FILE=/data/einsatzkleidung.json
