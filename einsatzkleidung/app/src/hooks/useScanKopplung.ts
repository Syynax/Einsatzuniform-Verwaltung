 ...
 *
 * Der Hook hängt bewusst an der Seite und nicht am Scan-Tab: Ein Wechsel auf
 * „Kleidung" hängt den Tab aus, die Kopplung soll aber weiterlaufen und Codes
 * weiter verbuchen.
 *
...
const SPEICHER_SCHLUESSEL = 'einsatzkleidung.scanKopplung';
